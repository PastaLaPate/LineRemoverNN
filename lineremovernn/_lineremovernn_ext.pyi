...
def generate_pages(target: str | os.PathLike, datasets: Sequence[Dataset], n: int = 5, preload: bool = False, use_arc: bool = True, document: bool = True, max_warp: float = 0.1, imperfect_lines: bool = True, save_xml: bool = False) -> None: ...
