...
def generate_pages(target: str | os.PathLike, datasets: Sequence[Dataset], n: int = 5, use_arc: bool = True, document: bool = True, max_warp: float = 0.1, imperfect_lines: bool = True, save_xml: bool = False, debug: bool = False, max_workers: int = 0, logger: object | None = None) -> None: ...
